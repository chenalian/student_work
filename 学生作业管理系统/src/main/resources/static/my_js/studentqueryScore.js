...
layui.use('table', function(){
    ...
    var infotable=table.render({
        elem: '#test3'
        ,url:'/student/studentqueryScores'
        ...
        ,cols: [[
            ...
            ,{field:'homeworkId', title:'作业', width:120,}
            ,{field:'studentId', title:'学生', width:150}
            ,{field:'type', title:'类型', width:80}
            ,{field:'filename', title:'文件名', width:100}
            ,{field:'text', title:'文本答案',width:80}
            ,{field:'info', title:'评价',width:80}
            ,{field:'piyu', title:'批语'}
            ,{field:'filescore', title:'文件分'}
            ,{field:'textscore', title:'文本分'}
            ,{field:'score', title:'总分',width:80,edit:'text'}
            // ,{fixed: 'tex', title:'操作', toolbar: '#barDemo3', width:150,fixed: 'right'}
        ]]
        ,page: true
    });
    //头工具栏事件
...
function uploadhomeworkscore(id,piyu,filescore,textscore) {
    ...
    * */
    ...
    $.ajax({
        method:"post",
        url:"/teacher/studentqueryScores",
